...
const Form = () => {
    ...
    return (
        <>
            ...
            <h5>Name: {state.fname} {state.lname}</h5><br />
            <p>Message: {state.message}</p><br />
            <h5>Favorite car brand: {state.carBrand}</h5><br />
            <h5>Is it checked? : {state.isChecked ? "Yes" : "No"}</h5><br />
            <h5>Gender : {state.gender}</h5><br />
